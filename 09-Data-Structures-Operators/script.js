...
const restaurant = {
  ...
  orderDelivery(starterIndex = 1, mainIndex = 0, time = '20:00', address) {
    console.log(
      `Order recieved! ${this.starterMenu[starterIndex]} and ${this.mainMenu[mainIndex]} will be delivired to ${address} at ${time}`
    );
  },
...
capitalizedName('yulii shtel');

// Padding a string
const message = 'Go to gare 23!';
...
console.log(maskCreditCard(80138392));
console.log(maskCreditCard(1239023801238392));
console.log(maskCreditCard('3284098758323801238'));
...
const checkMiddleSeat = function (seat) {
  ...
  if (s === 'B' || s === 'E') console.log('You got the miidle seat 😬');
...
const deteleCard = gameEvents.delete(64);
console.log(gameEvents);

// 3. Compute and log the following string to the console: "An event happened, on average, every 9 minutes" (keep in mind that a game has 90 minutes)

// const x = 90;
// const y = gameEvents.size;
// const z = x / y;
...
// Arrays
const users = [{ name: 'Jonas', email: 'hello@joans.io' }];
...
const printGoals = function (...num) {
  console.log(num);
  console.log(`${num} goals were scored`);
};
...
team1 < team2 && console.log(`Team 2 with odd: "${team2}" wins!`);
team1 > team2 && console.log(`Team 1 with odd: "${team1}" wins!`);
*/
...
/*
console.log('----- OR -----');
// Use ANY data type, return ANY data type, short-sircuting
console.log(3 || 'Jonas');
console.log('' || 'Jonas');
console.log(true || 0);
...
// SPREAD, because on a RIGHT side of =
const arr = [1, 2, ...[3, 4]];

// REST, because on a LEFT side of =
...
console.log(maskCreditCard(43219802));
console.log(maskCreditCard(432198027381232));
console.log(maskCreditCard('3112738123173821543572'));
