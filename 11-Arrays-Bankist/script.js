...
labelBalance.addEventListener('click', function () {
  const movementsUI = Array.from(
    ...
    const movementsUI2 = [...document.querySelectorA('.movements__value')];
  });
*/
...
// 4.
// this is a nice title -> This Is a Nice Titile
...
console.log(convertTitileCase('and here is another title with an EXAPMPLE'));
